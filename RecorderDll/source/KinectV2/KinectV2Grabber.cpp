...
/// <summary>
/// Zwalnia obiekty klas implementujπcych interfejsy,
/// np. IKinectSensor lub IFrameDescription.
/// </summary>
/// <typeparam name="Interface">Typ z publicznπ metodπ Release()</typeparam>
/// <param name="IRelease">Referencja do wskaünika na obiekt interfejsu.</param>
...
namespace pcl
{
    ...
    , signal_PointXYZRGBA( nullptr )
    {
        ...
        // Jeúli po metodzie Open w≥asnoúÊ isAvailable jest fa≥szem,
        // to znaczy, øe nieznaleziono kinecta.
        std::this_thread::sleep_for(std::chrono::milliseconds(1750)); // Czekanie, bo nieraz kinect nie by≥ dostÍpny.
        byte isAvailable;
